...
public class Global_builder : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        create_sectors_rays(sectors_net.transform, sector_pref, destr_ray_net.transform, destr_pref, ray_coord_x, new Vector2(sector_width, sector_high), new Vector2(sector_width_count, sector_high_count));
    ...
    void create_sectors_rays(Transform s_net, GameObject sector_pref, Transform d_net, GameObject destr_pref, float ray_coord_x, Vector2 vect_scale, Vector2 vect_count)
    {
